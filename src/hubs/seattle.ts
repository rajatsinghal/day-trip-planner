...
export const seattleHub: Hub = {
  ...
  destinations: [
    ...
    },
    {
      ...
      lon: -121.6923,
      elevation_m: 1554,
      reasons_to_visit: ['viewpoint', 'volcano', 'hike'],
    ...
    {
      id: 'larrabee-sp',
      name: 'Larrabee St Park (Chuckanut Drive)',
      lat: 48.6478,
      lon: -122.4856,
      reasons_to_visit: ['coast', 'hike'],
